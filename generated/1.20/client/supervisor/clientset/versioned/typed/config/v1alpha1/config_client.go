...
import (
	...
	"go.pinniped.dev/generated/1.20/client/supervisor/clientset/versioned/scheme"
...
func (c *ConfigV1alpha1Client) StarlarkFunctions(namespace string) StarlarkFunctionInterface {
	return newStarlarkFunctions(c, namespace)
}
