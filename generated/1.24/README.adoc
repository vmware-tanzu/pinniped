...
| *`organizationLoginPolicy`* __xref:{anchor_prefix}-go-pinniped-dev-generated-1-24-apis-supervisor-idp-v1alpha1-githuborganizationloginpolicy[$$GitHubOrganizationLoginPolicy$$]__ | OrganizationLoginPolicy must be set to "AllOrganizationsAllowed" if allowedOrganizations is empty. +
...
[id="{anchor_prefix}-go-pinniped-dev-generated-1-24-apis-supervisor-idp-v1alpha1-githuborganizationloginpolicy"]
