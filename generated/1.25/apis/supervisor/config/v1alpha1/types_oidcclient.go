...
type OIDCClientTokenLifetimes struct {
	...
	// identity provider. Giving these tokens a long life will allow the end user to continue to use a token while
	// avoiding these updates from the external identity provider, which is generally not desirable from a security
	// point of view.
