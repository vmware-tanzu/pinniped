...
type GitHubAPIConfig struct {
	...
	//
	// +kubebuilder:validation:XValidation:message="spec.gitHubAPI.tls.certificateAuthorityData must be a PEM bundle starting with '-----BEGIN CERTIFICATE----' and then base64-encoded",rule="has(self.certificateAuthorityData) && self.certificateAuthorityData.startsWith('LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tC')"
	// +optional
