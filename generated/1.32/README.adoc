...
[id="{anchor_prefix}-go-pinniped-dev-generated-1-32-apis-concierge-config-v1alpha1-credentialissuerkubeconfiginfo"]
...
| *`kubeConfigInfo`* __xref:{anchor_prefix}-go-pinniped-dev-generated-1-32-apis-concierge-config-v1alpha1-credentialissuerkubeconfiginfo[$$CredentialIssuerKubeConfigInfo$$]__ | Information needed to form a valid Pinniped-based kubeconfig using this credential issuer. +
