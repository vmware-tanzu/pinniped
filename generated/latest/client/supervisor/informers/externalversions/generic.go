...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("starlarkfunctions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Config().V1alpha1().StarlarkFunctions().Informer()}, nil
