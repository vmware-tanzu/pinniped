...
// When using v0.32.0, need to use this version of structured-merge-diff.
// See https://github.com/kubernetes/apimachinery/blob/v0.32.1/go.mod#L34
...
// see https://github.com/kubernetes/apimachinery/blob/v0.32.1/go.mod#L31
replace k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20241105132330-32ad38e42d3f

// see https://github.com/kubernetes/apiserver/blob/v0.32.1/go.mod#L21
