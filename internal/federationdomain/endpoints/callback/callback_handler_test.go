...
func TestCallbackEndpoint(t *testing.T) {
	...
	happyState := happyOIDCUpstreamStateParam().Build(t, happyStateCodec)
	happyStateForDynamicClient := happyOIDCUpstreamStateParamForDynamicClient().Build(t, happyStateCodec)
