	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlaceholderV1alpha1().LoginDiscoveryConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlaceholderV1alpha1().LoginDiscoveryConfigs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *loginDiscoveryConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&placeholderv1alpha1.LoginDiscoveryConfig{}, f.defaultInformer)
}
