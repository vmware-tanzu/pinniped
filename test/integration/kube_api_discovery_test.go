...
func TestCRDAdditionalPrinterColumns_Parallel(t *testing.T) {
	...
	expectedPinnipedCRDNames := []string{
		"activedirectoryidentityproviders.idp.supervisor.pinniped.dev",
		"credentialissuers.config.concierge.pinniped.dev",
		"federationdomains.config.supervisor.pinniped.dev",
		"githubidentityproviders.idp.supervisor.pinniped.dev",
		"jwtauthenticators.authentication.concierge.pinniped.dev",
		"ldapidentityproviders.idp.supervisor.pinniped.dev",
		"oidcclients.config.supervisor.pinniped.dev",
		"oidcidentityproviders.idp.supervisor.pinniped.dev",
		"webhookauthenticators.authentication.concierge.pinniped.dev"}
